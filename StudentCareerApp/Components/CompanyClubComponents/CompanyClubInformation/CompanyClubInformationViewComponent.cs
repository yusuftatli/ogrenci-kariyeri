...
namespace StudentCareerApp.Components.CompanyClubComponents.CompanyClubInformation
{
    ...
    {
        public async Task<IViewComponentResult> InvokeAsync(CompanyClubInformationDto model = null)
        {
            var res = model ?? new CompanyClubInformationDto
            {
                ...
                CompanyUserImage = "/images/turkcell-company.jpg"
            };
            return View("_CompanyClubInformation", res);
        }
    }
}
