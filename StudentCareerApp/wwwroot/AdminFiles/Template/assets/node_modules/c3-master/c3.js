...
c3_axis_fn.getXAxisTickFormat = function getXAxisTickFormat() {
    var $$ = this.owner,
        config = $$.config,
        format = $$.isTimeSeries() ? $$.defaultAxisTimeFormat : $$.isCategorized() ? $$.Category : function (v) {
...
c3_chart_internal_fn.redraw = function (options, transitions) {
    ...
    if (config.zoomrescale && !options.flow) {
...
c3_chart_fn.zoom = function (domain) {
    ...
    if (domain) {
        ...
        $$.brush.extent(domain);
        $$.redraw({ withUpdateXDomain: true, withY: $$.config.zoomrescale });
