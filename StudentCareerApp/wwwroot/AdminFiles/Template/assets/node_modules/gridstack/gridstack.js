...
(function(factory) {
    ...
    */
    ...
    var GridStack = function(el, opts) {
        ...
        if (typeof opts.always_showresize_handle !== 'undefined') {
            opts.alwaysShowResizeHandle = opts.always_showresize_handle;
            obsoleteOpts('always_showresize_handle', 'alwaysShowResizeHandle');
        }
        // jscs:enable requireCamelCaseOrUpperCaseIdentifiers
    ...
    GridStackEngine.prototype.can_be_placed_withrespect_to_height =
        obsolete(GridStackEngine.prototype.canBePlacedWithRespectToHeight,
        'can_be_placed_withrespect_to_height', 'canBePlacedWithRespectToHeight');
