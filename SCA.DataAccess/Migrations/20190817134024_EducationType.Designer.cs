...
namespace SCA.DataAccess.Migrations
{
    ...
    [Migration("20190817134024_EducationType")]
    partial class EducationType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCA.Entity.Model.Anouncement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SCA.Entity.Model.Comments", b =>
                {
                    ...
                    b.Property<string>("DescriYorumption");
            ...
            modelBuilder.Entity("SCA.Entity.Model.CompanyClubs", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<byte>("CompanyClupType");
            ...
            modelBuilder.Entity("SCA.Entity.Model.ImageGalery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<long>("CompanyClubId");

                    b.Property<long?>("CompanyClubsId");
                    ...
                    b.HasIndex("CompanyClubsId");

                    b.ToTable("ImageGalery");
                });
            ...
            modelBuilder.Entity("SCA.Entity.Model.ImageGalery", b =>
                {
                    b.HasOne("SCA.Entity.Model.CompanyClubs", "CompanyClubs")
                        .WithMany("ImageGalery")
                        .HasForeignKey("CompanyClubsId");
                });
            ...
            modelBuilder.Entity("SCA.Entity.Model.Users", b =>
                {
                    ...
                    b.HasOne("SCA.Entity.Model.EducationStatus", "EducationStatus")
                        .WithMany("Users")
                        .HasForeignKey("EducationStatusId1");
